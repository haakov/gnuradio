    ...
    def _rebuild(self):
        ...
        for block in self._imports:
            ...
            if block.enabled:
                ...
                import_.setForeground(0, self._tree.palette().color(self.palette().Disabled, QPalette.ColorRole.WindowText))
                import_.setForeground(1, self._tree.palette().color(self.palette().Disabled, QPalette.ColorRole.WindowText))
            ...
            if block.key == 'variable':
                ...
                if block.enabled:
                    ...
                    variable_.setForeground(0, self._tree.palette().color(
                        self.palette().Disabled, QPalette.ColorRole.WindowText))
